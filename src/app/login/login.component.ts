...
export class LoginComponent implements OnInit {
  ...
  constructor(private router: Router, private ds: UserDataService, private spinner: NgxSpinnerService
    , private fb: FormBuilder, private loginDataService: LoginService) {
